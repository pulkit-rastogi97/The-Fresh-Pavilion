    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="col-md-12 header">
                <h1 align="center"><a href="<%= request.getContextPath()%>/">The Fresh Pavilion</a></h1>
            </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="<%= request.getContextPath()%>/product"><i class="fa fa-paypal"></i> Add Product</a></li>
