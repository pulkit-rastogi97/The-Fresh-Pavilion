...
<body>
	<c:if test="${user_id == null}">
		<%
			response.sendRedirect("http://localhost:8080/The_Fresh_Pavillion/home");
		%>
	</c:if>
	...
	<div class="container">
		...
		<div class="col-md-12 header">
			<h1 align="center">
				<a href="<%=request.getContextPath()%>/">The Fresh Pavillion</a>
			</h1>
		</div>
					...
					<div class="collapse navbar-collapse" id="myNavbar">
						<ul class="nav navbar-nav">
							...
							<li><a href="<%=request.getContextPath()%>/product"><i
									class="fa fa-paypal"></i> Add Product</a></li>
							<li class="active"><a
								href="<%=request.getContextPath()%>/customer"><i
									class="fa fa-user-plus"></i> Register Customer</a></li>
							<li><a href="<%=request.getContextPath()%>/order_details"><i
									class="fa fa-area-chart"></i> Order Details</a></li>
						</ul>
		...
		<div class="student_form col-md-4">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label for="cname">Name:</label> <input value="${customer.cname}"
							name="cname" type="text" class="form-control" id="cname">
					</div>

					<div class="form-group">
						<label for="phone">Phone:</label> <input value="${customer.phone}"
